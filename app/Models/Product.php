...
class Product extends Model
{
    ...
    {
        return $this->hasOne(ProductTranslation::class)->where('language_code', App::getLocale());
    }
    ...
    {
        return $this->belongsToMany(AttributeValue::class, 'product_attribute_values')->with('attribute', 'translations');
    }
    ...
    {
        return $this->belongsToMany(Country::class, 'product_shipping_countries');
    }
}
