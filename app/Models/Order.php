...
class Order extends Model
{
    ...
    public function trackingEvents(){return $this->hasMany(OrderTrackingEvent::class,'order_id');}
    public function disputes(){return $this->hasMany(Dispute::class,'order_id');}
